...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String? _country; // Changed to nullable
  ...
  Future<void> _loadCountries() async {
    try {
      ...
      setState(() {
        ...
        // Set default country only after countries are loaded
        _country = _countries.isNotEmpty ? _countries.first : null;
        _isLoading = false;
      });
    } catch (e) {
      _showToast('Error fetching countries: $e');
      setState(() {
        _isLoading = false;
      });
    }
  ...
  void _register() async {
    ...
    if (selectedHabits.isEmpty) {
      _showToast('Please select at least one habit');
      return;
    }
